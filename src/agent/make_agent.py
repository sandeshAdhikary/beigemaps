...
from src.agent.bisim_agent_spectral import BeigemapDBCAgent
from src.agent.bisim_agent_ksme import KSMEBisimAgent, BeigeMapKSMEAgent
from src.agent.sac_agent import SACAgent
from src.agent.rap_agent import RAPBisimAgent, BeigeMapRAPAgent
...
def make_agent(obs_shape, action_shape, args, device):
    ...
    if args.agent == 'bisim':
        if args.encoder_mode == 'dbc':
        ...
        elif args.encoder_mode == 'beigemap_dbc':
            agent_kwargs.update({
                'normalize_kernel': args.normalize_kernel,
                'distance_type': 'bisim',
                'normalization_mode': args.normalization_mode
                })
            agent = BeigemapDBCAgent(**agent_kwargs)
        ...
        elif args.encoder_mode == 'beigemap_ksme':
            ...
            agent = BeigeMapKSMEAgent(**agent_kwargs)
        ...
        elif args.encoder_mode == 'beigemap_rap':
            agent_kwargs.update({
                'rap_structural_distance': args.rap_structural_distance,
                'rap_reward_dist': args.rap_reward_dist,
                'rap_square_target': args.rap_square_target,
            ...
            agent = BeigeMapRAPAgent(**agent_kwargs)
        else:
